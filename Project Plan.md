...
|--------------|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|-----------------------|
| 2            | Develop Project Plan                  | Plan out all activities to be completed for this project.                                                                                                                                   | TBD      | All                   |
| 2.1          | Define Project Objectives             | Identify and document the key objectives for the project.                                                                                                                                   | TBD      | Jacob                 |
| 2.2          | Identify Project Stakeholders         | List all necessary stakeholders involved in the project.                                                                                                                                    | TBD      | Glyza                 |
| 2.3          | Define Project Scope                  | Clearly outline scope of the project.                                                                                                                                                       | TBD      | Jacob                 |
| 2.4          | Develop WBS                           | Create a structured hierarchy of tasks to complete the project.                                                                                                                             | TBD      | Jacob                 |
| 2.5          | Activity Definition Estimate          | Estimate the duration and assigned members for each project task.                                                                                                                           | TBD      | Chathumika & Jacob    |
| 2.6          | Gantt Chart Preparation               | Produce a Gantt chart to visualize the project timeline for tasks.                                                                                                                          | TBD      | Chathumika & Glyza    |
| 2.7          | Develop Software Design Document      | Prepare a document that outlines the architecture and design of the application.                                                                                                            | TBD      | All                   |
| 2.7.1        | System Vision                         | Define the vision of the system and its requirements/goals.                                                                                                                                 | TBD      | All                   |
| 2.7.1.1      | Problem Background                    | Identify the background of the problem being solved.                                                                                                                                        | TBD      | Jacob                 |
| 2.7.1.2      | System Capabilities Overview          | Identify the capability and features of the system being developed.                                                                                                                         | TBD      | Chathumika            |
| 2.7.1.3      | Benefit Analysis                      | Analyze and identify the benefits provided from the development of this application.                                                                                                        | TBD      | Glyza                 |
| 2.7.2        | Requirements                          | Define user and software requirements.                                                                                                                                                      | TBD      | All                   |
| 2.7.2.1      | User Requirements                     | Detail how users are expected to interact with or use the program (create a fictional user).                                                                                                | TBD      | Jacob                 |
| 2.7.2.2      | Software Requirements                 | Define the functionality which the application will provide.                                                                                                                                | TBD      | Chathumika            |
| 2.7.2.3      | Use Case Diagram                      | Provide a system-level Use Case Diagram illustrating all required features.                                                                                                                 | TBD      | Glyza                 |
| 2.7.2.4      | Use Cases                             | Develop detailed descriptions of each use case, at least 5 use cases, each corresponding to specific functions.                                                                             | TBD      | Jacob                 |
| 2.7.3        | Software Design and System Components | Document the software design and the components that will make up the system.                                                                                                               | TBD      | All                   |
| 2.7.3.1      | Software Design                       | Make flowchart that illustrates how the software will operate.                                                                                                                              | TBD      | Glyza                 |
| 2.7.3.2      | System Components                     | List components and their roles within the system.                                                                                                                                          | TBD      | Chathumika            |
| 2.7.3.2.1    | Functions                             | List all key functions within the software, for each define the description, input parameters, return value and side effects.                                                               | TBD      | Jacob                 |
| 2.7.3.2.2    | Data Structures / Data Sources        | List all data structures or sources used in the software, for each provide type, usage and functions.                                                                                       | TBD      | Chathumika            |
| 2.7.3.2.3    | Detailed Design                       | Provide pseudocode or flowcharts for all functions listed in 2.7.3.2.1.                                                                                                                     | TBD      | Glyza                 |
| 2.7.4        | UI Design                             | Design the user interface for the application.                                                                                                                                              | TBD      | Glyza                 |
| 2.7.4.1      | Structural Design                     | Present a structural design, a hierarchy chart, showing the overall interface's structure, address structure, information, navigation and design choices.                                   | TBD      | Chathumika            |
| 2.7.4.2      | Visual Design                         | Include all wireframes or mockups of the interface. Provide a discussion, explanation and justification for design choices, include interface components, screens/menus and design details. | TBD      | All                   |
| 3.1          | Develop Software Components           | Build and implement software components for the application.                                                                                                                                | TBD      | All                   |
| 3.2          | Integrate Software Components         | Combine all software components and ensure they work together.                                                                                                                              | TBD      | All                   |
| 3.3          | Perform Initial Testing               | Conduct testing to identify any issues or bugs in the software before publishing.                                                                                                           | TBD      | All                   |
| 4.1          | Status Reports                        | Regular updates on the projects and any issues encountered, git logs.                                                                                                                       | TBD      | All                   |
| 4.2          | Update Plans                          | Change project plans based on progress or feedback.                                                                                                                                         | TBD      | All                   |
| 5.1          | Final Performance Review              | Conduct a review of the final system based on the initial project objectives.                                                                                                               | TBD      | All                   |
| 5.2          | Prepare Final Report                  | Compile a report summarizing the projects outcomes.                                                                                                                                         | TBD      | All                   |
